...
function AppRoutes() {
  ...
  return  (
    <Routes>
      ...
      />
      <Route path="/Recipes" element={<RecipeList favorites={favorites} addToFavorites={addToFavorites} removeFromFavorites={removeFromFavorites} showOnlyFavorites={false}/>}>
